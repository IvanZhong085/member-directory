...
const SITE = {
  ...
  MEMBER_FORM_URL:  "https://docs.google.com/forms/d/e/1FAIpQLSfpANy9jsQRtSwOV97fXvqV5LfXWoOyMRrWyzlCdJhHwhmWlQ/viewform",
                            // 夥伴補資料表單(createMemberForm)→ 後台「缺資料」催收訊息會附上
  VISITOR_FORM_URL: "",     // 來賓參訪報名表單(createVisitorForm)→ visitor.html 的「我要報名參訪」按鈕
